...
| `<ade_name>.code-workspace` | Multi-root Cursor workspace listing all portfolio repos. Regenerated by `ade-install.sh` from `ade-repos.txt`; opened automatically on first scaffold only |
